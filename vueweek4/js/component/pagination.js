export default {
    ...
    template:`<nav aria-label="Page navigation example">
        ...
        <li class="page-item" :class="{'active': item === page.current_page}" v-for="item in page.total_pages" :key="item"><a class="page-link" href="#" @click.prevent="$emit('get-product',item)">{{item}}</a></li>
